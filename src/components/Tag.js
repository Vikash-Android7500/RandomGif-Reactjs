...
const Tag = () => {
  ...
  return (
    <div className="md:w-full w-[100%] gap-5 p-5 bg-violet-300 text-center flex flex-col items-center rounded-lg border-b-green-700 border-b-8 border shadow-lg">
      ...
      {loading ? (
        ...
        <img
          src={gif}
          alt="Gif File"
          className="overflow-hidden w-[400px] h-[310px] m-auto rounded-lg"
        />
      )}
